...
class App extends React.Component {
        ...
        render() {
            ...
            return ( <
                ...
                <
                h2 class = "id" > Youtube - Downloader < /h2> <
                ...
                ul className = "format-list" > {
                    formats.map((format) => {
                        return ( <
                            ...
                            className = "radio-label" > { format.name } <
                            /label> <
                            /li>
                        );
                    })
                ...
                /section> {
                    currentVideoInfo && ( <
                        ...
                        img src = { `https://i.ytimg.com/vi/${currentVideoInfo.videoId}/hqdefault.jpg` }
                ...
                section className = "suggestions-section" > {!!suggestions.length && < h1 > Suggestions < /h1>} <
                    div className = "grid" > {
                    ...
                    className = "hidden"
                    ref = {
                        (ref) => (this.hiddenDownloadBtn = ref) } >
                    { downloadUrl } <
                    /a> <
                    />
                );
